...
tinymce.PluginManager.add('coolsiteimage', function(editor) {
...
// 
		...
		// } else {
			...
			// });
		// }
		LIST.material.insert=onSubmitForm;
		LIST.material.open('Image');
	}

	editor.addButton('coolsiteimage', {
		icon: 'image',
	...
	editor.addMenuItem('coolsiteimage', {
		icon: 'image',
		text: 'Insert image',
		onclick: createImageList(showDialog),
		context: 'insert',
